...
class Baseline(nn.Module):
    def __init__(self, input_dim, hidden_dim=128, embedding_dim=32, num_classes=30):
        super().__init__()
        ...
        # Encoder RNN
        self.encoder = nn.GRU(80, hidden_dim, batch_first=True)
    ...
    def forward(self, x, prev_tokens, teacher_forcing_ratio=0.5):
        ...
        # Store all outputs
        outputs = torch.zeros(batch_size, max_len, self.classifier.out_features).to(x.device)
